...
addprofile.addEventListener("click",addnewprofile)
...
const addingprofile = ()=>{
    ...
    <div>
     ...
     alt="">
       ...
       <h4 class="profilename">priyanshu</h4>
    </div>
   
 `
 div.appendChild(innerdiv)
    profilelogo.appendChild(innerdiv) 
...
managebutton.addEventListener("click",addingprofile)
